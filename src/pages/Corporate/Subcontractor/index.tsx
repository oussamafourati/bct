                ...
                <Container fluid={true}>
                        ...
                        <Card.Header className="border-bottom-dashed">
                            <Row className="align-items-center g-3">
                                <Col className="col-xxl-auto col-sm-auto ms-auto">
                                    <Button variant='success' onClick={() => tog_AddShippingModals()} className="add-btn"><i className="bi bi-plus-circle me-1 align-middle"></i> Add Sub-Contractor</Button>
                                </Col>
                            </Row>
                        </Card.Header>
                        <Card.Header className="border-bottom-dashed">
                    ...
                    <Modal className="fade zoomIn" size="lg" show={modal_AddShippingModals} onHide={() => { tog_AddShippingModals(); }} centered>
                        <Modal.Header className="px-4 pt-4" closeButton>
                            <h5 className="modal-title fs-18" id="exampleModalLabel">Add Team</h5>
                        </Modal.Header>
                                ...
                                <Row>
                                    ...
                                    <Col lg={12}>
                                        <div className="hstack gap-2 justify-content-end">
                                            ...
                                            <Button variant='primary' id="add-btn">Add Team</Button>
                                        </div>
                                    </Col>
                                </Row>
                            </Form>
