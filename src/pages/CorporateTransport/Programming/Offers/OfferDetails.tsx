          ...
          <Row className="mb-4 align-items-center">
            ...
            <Col className="col text-end">
              <Button variant="secondary">
                <i className="ph-download-simple me-1 align-middle"></i> Invoice
              </Button>
            </Col>
          </Row>
              ...
              <div className="card card-primary overflow-hidden">
                <div className="position-absolute end-0 start-0 bottom-0 z-0">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop
                          stopColor="rgba(var(--tb-white-rgb), 0)"
                          offset="0"
                        ></stop>
                        <stop
                          stopColor="rgba(var(--tb-white-rgb), 0.1)"
                          offset="1"
                        ></stop>
                      </linearGradient>
                      <linearGradient
                ...
                <div className="card-body position-relative">
                  ...
                  <p className="text-white-75">
                    Orders are one of the main building blocks of creating an an
                    ad campaign in Ad Manager.
                  </p>
                  <Link to="#!" className="link-light">
                    Create Order <i className="ph-arrow-right align-middle"></i>
                  </Link>
                </div>
              </div>
            </Col>
                  ...
                  <Card>
                    <div className="card-header d-flex align-items-center">
                      ...
                      <div className="flex-shrink-0">
                        <Link to="#track-order" className="btn btn-sm btn-info">
                          Track Order
                        </Link>
                      </div>
                    </div>
                        ...
                        <table className="table table-sm table-borderless align-middle description-table mb-0">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <span className="fw-medium">Debit Card</span>
                              </td>
                            </tr>
                            <tr>
                              <td>Card Number:</td>
                            ...
                            <tr>
                              <td>Total Amount</td>
                              <td>
                                <span className="fw-medium">$1868.98</span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
              ...
              <Card id="track-order">
                ...
                <div className="card-body">
                  <Row className="justify-content-between">
                    <Col
                      lg={2}
                      className="order-tracking text-center completed"
                    >
